...
;( function ( $ ) {
	...
	var defaults = {
	messageText: "Utilizamos cookies (y otras tecnologías similares) para recopilar datos para mejorar su experiencia en nuestro sitio.",
	...
	acceptText: "Aceptar Todo",		            // Accept button text
	infoEnable: true,							// Show the More Info button
	infoText: "Más Información",					    // More Info button text
	infoUrl: "about-us.html",				    // More Info button URL
